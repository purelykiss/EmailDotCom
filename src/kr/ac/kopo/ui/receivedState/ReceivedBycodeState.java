...
public class ReceivedBycodeState extends BaseMailState {
	public ReceivedBycodeState(IMailUI parent) {
	...
	public void execute() {
		...
		EmailVO email = EmailService.getInstance().getEmail(1, input);
		
		if(email != null)
			ViewManager.getInstance().ViewMail(1, input);
		else
