...
public class SentBycodeState extends BaseMailState {
	public SentBycodeState(IMailUI parent) {
	...
	public void execute() {
		...
		EmailVO email = EmailService.getInstance().getEmail(2, input);
		
		if(email != null)
			ViewManager.getInstance().ViewMail(2, input);
		else
