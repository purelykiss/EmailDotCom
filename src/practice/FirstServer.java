...
public class FirstServer {
    ...
    public FirstServer(int port) throws IOException {
       createServer(HOSTNAME, port);
    }
    public FirstServer(String host, int port) throws IOException {
    ...
    public static void main(String[] args) {
        FirstServer httpServerManager = null;
        ...
        try{
            ...
            //서버 생성
            httpServerManager = new FirstServer("localhost",3000);
